	...
	<table class="table" width="98%" layoutH="85">
		<thead>
			<tr>
				...
				<th width="5%" orderField="mch_id">商户号</th>
				<th width="5%" orderField="client_no">商户号</th>
				<th width="10%" orderField="client_name">商户名</th>
				<th width="10%" orderField="service">交易类型</th>
				<th width="10%" orderField="localdate">交易时间</th>
				<th width="5%" orderField="res_code">返回码</th>
				<th width="10%" orderField="transaction_id">渠道订单号</th>
