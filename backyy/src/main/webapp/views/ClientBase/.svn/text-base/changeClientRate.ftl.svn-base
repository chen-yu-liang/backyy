		...
		<div class="pageFormContent" layoutH="45" style="background-color:#ecf2f4;overflow:hidden;padding-bottom:0">
			<fieldset> 
				<p>
					...
					<input type="text" name="client_no" value="${(client_no)!}" readonly="readonly"/>
				</p>
				<p>
					<label style="width:60px;">商户名称</label>
					<input type="text" name="client_name" value="${(client.client_name)!}" readonly="readonly" />
				</p>
				<p>
					<label style="width:60px;">费率编号</label>
					<select name="rate_no"   selectvl="${client.rate_no}" selectvl_event="true" class="required">
