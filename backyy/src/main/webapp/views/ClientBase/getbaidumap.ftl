...
<div style="margin-top: 5px">
    <input type="text" onkeypress="EnterPress()" style="width:200px;height:20px" id="txtContent">
    <input type="button" style="width:50px;height:25px" id="search" value="搜索" onclick="searchMap()"/>
</div>
<div style="margin-top: 12px">
	<div id="map" style="width:1440px;height:680px;float:left" ></div>
	<div id="r-result" style="width:260px;float:right"></div>	
</div>
