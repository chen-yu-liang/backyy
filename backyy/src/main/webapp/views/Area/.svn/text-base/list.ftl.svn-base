...
<div class="pageContent">
	...
	<table class="table" width="98%" layoutH="109">
		<thead>
			<tr>
				<th width="10%" orderField="area_id"></th>
				<th width="10%" orderField="area_code"></th>
				<th width="10%" orderField="area_name"></th>
				<th width="10%" orderField="area_status"></th>
				<th width="10%" orderField="parent_id"></th>
			</tr>
		</thead>
		<tbody>
