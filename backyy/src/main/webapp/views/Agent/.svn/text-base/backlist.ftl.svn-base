...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			-->
			<li><a class="edit permission" href="${(projectName)!}/?spm=${(urlEncrption('/${(action)!}/add'))!}&id={cm}" target="dialog"  width="900" height="500" rel="Agent_add" title="修改-{cn}"><span>修改</span></a></li>
