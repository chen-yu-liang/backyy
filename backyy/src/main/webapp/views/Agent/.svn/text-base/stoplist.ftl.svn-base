...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete permission" href="${(projectName)!}/?spm=${(urlEncrption('/${(action)!}/update'))!}&id={id}&status=2" target="ajaxTodo" rel="Agent_update" title="确定要停启用【{cn}】吗?"><span>启用</span></a></li>
