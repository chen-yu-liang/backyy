...
public interface BaseDao<T,PK extends Serializable>{
	...
	public Object selectOne(String statement,Object parameter);//获取一条记录
	...
	public String getString(String statement,Object parameter);//返回一个字符串
	public String getString(String statement);//返回一个字符串
